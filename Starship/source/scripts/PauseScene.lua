...
gridview:setNumberOfColumns(#items)
...
function gridview:drawCell(section, row, column, selected, x, y, width, height)
    ...
    gfx.drawTextInRect(tostring(items[row]["name"]) .. ": " .. tostring(items[row]["quantity"]), x - 10,
        y + (height / 2 - fontHeight / 2) + 2, width, height, nil, nil,
