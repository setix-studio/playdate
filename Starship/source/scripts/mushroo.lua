...
class('Mushroo').extends(Room)

function Mushroo:enter()
...
function Mushroo:resetCosmo()
    self.cosmo:moveTo(self.spawnX, self.spawnY)
end

function Mushroo:update()
    cosmoHUD()
...
function Mushroo:enterRoom(direction)
...
function Mushroo:goToLevel(levelName)
